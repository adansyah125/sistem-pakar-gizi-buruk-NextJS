...
INSERT INTO gejala (id_admin, id_penyakit, nama_gejala, cf) VALUES
  (1, 1, 'bengkak seluruh tubuh', 0.9),
  (1, 1, 'bengkak pada kedua punggung kaki', 0.8),
  (1, 1, 'bila ditekan tidak sakit', 0.7),
  (1, 1, 'perubahan rambut', 0.5),
  (1, 1, 'rambut tipis', 0.4),
  (1, 1, 'rambut kusam', 0.3),
  (1, 1, 'mudah dicabut', 0.4),
  (1, 1, 'perubahan kulit', 0.5),
  (1, 1, 'kulit kering', 0.3),
  (1, 1, 'terdapat bercak merah muda', 0.6),
  (1, 1, 'otot menyusut', 0.6),
  (1, 2, 'bengkak seluruh tubuh', 0.7),
  (1, 2, 'badan sangat kurus', 0.9),
  (1, 2, 'wajah seperti orang tua', 0.8),
  (1, 2, 'kadang-kadang nafsu makan baik', 0.6),
  (1, 2, 'perubahan mental', 0.6),
  (1, 2, 'cengeng dan rewel', 0.5),
  (1, 2, 'bibir kering dan pecah-pecah', 0.5),
  (1, 2, 'perubahan rambut', 0.4),
  (1, 2, 'rambut tipis', 0.3),
  (1, 2, 'rambut kusam', 0.3),
  (1, 2, 'rambut kering', 0.3),
  (1, 2, 'perubahan kulit', 0.4),
  (1, 2, 'kulit kering', 0.3),
  (1, 2, 'terdapat bercak merah muda', 0.5),
  (1, 2, 'dinding perut tipis', 0.6),
  (1, 3, 'badan sangat kurus', 0.9),
  (1, 3, 'wajah seperti orang tua', 0.8),
  (1, 3, 'cengeng dan rewel', 0.5),
  (1, 3, 'perubahan rambut', 0.4),
  (1, 3, 'rambut tipis', 0.3),
  (1, 3, 'rambut kusam', 0.3),
  (1, 3, 'rambut mudah dicabut', 0.4),
  (1, 3, 'perubahan kulit', 0.4),
  (1, 3, 'kulit kering', 0.3),
  (1, 3, 'terdapat bercak merah muda', 0.4),
  (1, 3, 'otot menyusut', 0.7),
  (1, 3, 'dinding perut tipis', 0.6);
